    ...
    <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
          Actionable strategies and expert insights to help you grow your business online.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {magnets?.map((magnet) => (
          <div key={magnet.id} className="bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-white/5 rounded-[2rem] p-8 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-primary/30 flex flex-col h-full">
